...
const stripePromise = loadStripe(
  "pk_test_51Ix6MXDhSyK2k5ddZxfXQGR3UprqoTnAewpFFfoCtMf6Zm5nFtpI4TgZmd994naMvDbPHWZcyjap6nzFjWqtNVbY001eiOdu9C"
);
...
function Checkout() {
  ...
  return (
    <>
      <Link to="./MyBookings">
        <button
          className="py-3 mt-10 ml-10 text-black rounded-md font-xs w-sm focus:outline-none "
          type="submit"
        >
          Go to my bookings{" "}
        </button>
      ...
      <div className="container flex h-full max-w-md mx-auto mt-6 mb-6 overflow-hidden bg-white rounded-lg shadow xl:max-w-3xl">
        <div className="w-full p-8 xl:w-1/2">
          <form action="">
            ...
            <h3 className="block mb-2 text-sm font-semibold text-gray-700">
              <strong>Name:</strong> {bookings.name}{" "}
            </h3>
            <h3 className="block mb-2 text-sm font-semibold text-gray-700">
              <strong>Phone:</strong> {bookings.phonenumber}{" "}
            </h3>
            ...
            <button
              className="py-3 mt-10 text-white uppercase bg-gray-400 rounded-md ml-36 font-small w-sm focus:outline-none hover:bg-gray-400 hover:shadow-none"
              role="link"
              onClick={handleClick}
            >
              PAY NOW

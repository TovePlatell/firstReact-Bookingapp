...
export default function confirmBooking({price, test}){
...
<div className="flex flex-col h-screen bg-gray-100">
  ...
  <form className="max-w-xl p-10 m-4 bg-white rounded shadow-xl">
    ...
    <div className="mt-2">
      ...
      <input className="w-full px-5 py-4 text-gray-700 bg-gray-200 rounded" value={getUser()} id="cus_email" name="cus_email" type="text" required="" placeholder="Your Email" aria-label="Email" />
    </div>
    <div className = "mt-2">
    ...
    <div clasName="mt-4">
      <button className="px-4 py-1 font-light tracking-wider text-white bg-gray-900 rounded" type="submit" value={price}>SEK </button>
    </div>

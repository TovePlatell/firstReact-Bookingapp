            ...
            <div className="container flex h-full max-w-md mx-auto mt-6 mb-6 overflow-hidden bg-white rounded-lg shadow xl:max-w-3xl">
              ...
              <div className="w-full p-8 xl:w-1/2">
                <form action="">
                  ...
                  <p className="block mb-2 text-sm font-semibold text-gray-700">
                    <strong>Description:</strong> {booking.product.description}{" "}
                  </p>
                  <p className="block mb-2 text-sm font-semibold text-gray-700">
                    <strong>Price:</strong> {booking.product.price}{" "}
                    <span>SEK</span>{" "}
                  </p>
                  ...
                  <button
                    ...
                    className="px-3 py-2 mt-6 text-xs bg-gray-300 rounded text-grey font-xs"
                  >
                    {" "}
                    Cancel this booking
                  </button>
